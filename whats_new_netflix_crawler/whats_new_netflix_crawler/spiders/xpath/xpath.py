...
season_number_xpath='//div[h5[contains(text(),"%s")]]//small/text()'
year_xpath='//div[h5[contains(text(),"%s")]]//small/text()'
tv_rating_xpath='//div[h5[contains(text(),"%s")]][@class="new-title-right"]//p//preceding-sibling::text()'
description_xpath='//div[h5[contains(text(),"%s")]]/p[@class="title-description"]/text()'
other_info_xpath='//div[h5[contains(text(),"%s")]]//b//text()'
info_xpath='//div[h5[contains(text(),"%s")]]//b[text()="%s"]//following-sibling::text()'

...
class db_output_stats:
    ...
    def __init__(self):  
        ...
        self.connection=''
        self.cursor=''
        self.fieldnames=["netflix_id","title","image","imdb_rating","url","content_type","show_type","season_number","year","tv_rating","description","genre","cast","director","duration","language","updated_db","item_category"]
    ...
    def main(self):
        ...
        with output_file as outputcsvfile:
            ...
            query="select netflix_id,title,image,imdb_rating,url,content_type,show_type,season_number,year,tv_rating,description,genre,cast,director,duration,language,updated_db,item_category from netflix"
